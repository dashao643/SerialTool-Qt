...
void ModbusTab::setSlaveAddress(QString addr) { m_slaveAddress = addr.trimmed(); }
QString ModbusTab::getSlaveAddress() const { return m_slaveAddress; }
...
QString ModbusTab::DHT11_READ_TEMP()  { return m_slaveAddress + " 03 00 00 00 01"; }
QString ModbusTab::DHT11_READ_HUMI()  { return m_slaveAddress + " 03 00 01 00 01"; }
QString ModbusTab::DHT11_READ_TH()    { return m_slaveAddress + " 03 00 00 00 02"; }

QString ModbusTab::RTC_SET_TIME()      { return m_slaveAddress + " 06 00 10 00 00"; }
QString ModbusTab::RTC_GET_TIME()      { return m_slaveAddress + " 03 00 10 00 06"; }
